...
shinyUI(
    ...
    navbarPage(
        ...
        tabPanel(
            ...
            h3("Author:charchit bakliwal , date:January 24, 2018"),
            ...
            p("Source code of this application is available at",
              a(href = "https://github.com/charchitjain/Week-4-Data-product-project",
                "https://github.com/charchitjain/Week-4-Data-product-project")
            )
