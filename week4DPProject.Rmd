---
title: Developing Data Products course - Assignment Week 4 - Shiny Application and   Reproducible
  Pitch
...
## Application
 ...
 - The second half of the mentioned assignment was to develop a web application. The application was named ***MPG Prediction***. An instance is up & running at <https://charchit.shinyapps.io/week4DataProductProject/>.
 ...
 - The application and the current presentation source codes can be found at <https://github.com/charchitjain/Week-4-Data-product-project>. The application comprises 3 files: *ui.R* (UI), *server.R* (backend) and *modelBuilding.R* (Random Forest predictor).
